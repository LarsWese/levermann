...
class Share(db.Model):
    ...
    detail_page_ov: str = db.Column(db.String)
    ...
    currency: str = db.Column(db.String)
    fiscal_year_end: date = db.Column(db.Date)
    logo_url: str = db.Column(db.String)
    long_description_ov: str = db.Column(db.String)
    long_description_yahoo: str = db.Column(db.String)
    long_description_fingreen: str = db.Column(db.String)
    detail_page_fingreen: str = db.Column(db.String)
